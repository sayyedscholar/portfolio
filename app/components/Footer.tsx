...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { icon: Instagram, href: 'https://instagram.com/amaanullah.sayyed', label: 'Instagram' },
    { icon: Facebook, href: 'https://facebook.com/amaanullah.sayyed', label: 'Facebook' },
  ]
    ...
    <footer className="bg-gray-100 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold gradient-text mb-4">Amaanullah Sayyed</h3>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800 text-center text-gray-600 dark:text-gray-400">
          <p>&copy; {currentYear} Amaanullah Sayyed. {t('footer.copyright')}</p>
        </div>
      </div>
    </footer>
  )
